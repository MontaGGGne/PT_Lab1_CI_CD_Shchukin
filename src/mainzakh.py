...
from CalcQuartileszak import CalcQuartilesZakh
...
def main():
    ...
    print("Rating: ", rating)
    quart_sec = CalcQuartiles(students).calc()
    print("Second quartile: ", quart_sec)
    quart_first = CalcQuartilesZakh(students).calc()
    print("First quartile: ", quart_first)
